...
const (
	...
	SUBMISSIONService_ListSubmissions_FullMethodName        = "/asset.SUBMISSIONService/ListSubmissions"
	SUBMISSIONService_GetSubmissionById_FullMethodName      = "/asset.SUBMISSIONService/GetSubmissionById"
...
type SUBMISSIONServiceClient interface {
	...
	ListSubmissionParents(ctx context.Context, in *ListSubmissionParentsRequest, opts ...grpc.CallOption) (*ListSubmissionParentsResponse, error)
	ListSubmissions(ctx context.Context, in *ListSubmissionsRequest, opts ...grpc.CallOption) (*ListSubmissionsResponse, error)
	GetSubmissionById(ctx context.Context, in *GetSubmissionByIdRequest, opts ...grpc.CallOption) (*GetSubmissionByIdResponse, error)
...
func (c *sUBMISSIONServiceClient) CreateSubmissionParent(ctx context.Context, in *CreateSubmissionParentRequest, opts ...grpc.CallOption) (*CreateSubmissionParentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateSubmissionParentResponse)
	err := c.cc.Invoke(ctx, SUBMISSIONService_CreateSubmissionParent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sUBMISSIONServiceClient) ListSubmissionParents(ctx context.Context, in *ListSubmissionParentsRequest, opts ...grpc.CallOption) (*ListSubmissionParentsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListSubmissionParentsResponse)
	err := c.cc.Invoke(ctx, SUBMISSIONService_ListSubmissionParents_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sUBMISSIONServiceClient) GetSubmissionById(ctx context.Context, in *GetSubmissionByIdRequest, opts ...grpc.CallOption) (*GetSubmissionByIdResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetSubmissionByIdResponse)
	err := c.cc.Invoke(ctx, SUBMISSIONService_GetSubmissionById_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SUBMISSIONServiceServer interface {
	...
	ListSubmissionParents(context.Context, *ListSubmissionParentsRequest) (*ListSubmissionParentsResponse, error)
	ListSubmissions(context.Context, *ListSubmissionsRequest) (*ListSubmissionsResponse, error)
	GetSubmissionById(context.Context, *GetSubmissionByIdRequest) (*GetSubmissionByIdResponse, error)
...
func (UnimplementedSUBMISSIONServiceServer) CreateSubmissionParent(context.Context, *CreateSubmissionParentRequest) (*CreateSubmissionParentResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateSubmissionParent not implemented")
}
func (UnimplementedSUBMISSIONServiceServer) ListSubmissionParents(context.Context, *ListSubmissionParentsRequest) (*ListSubmissionParentsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListSubmissionParents not implemented")
}
...
func (UnimplementedSUBMISSIONServiceServer) GetSubmissionById(context.Context, *GetSubmissionByIdRequest) (*GetSubmissionByIdResponse, error) {
...
func _SUBMISSIONService_CreateSubmissionParent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateSubmissionParentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SUBMISSIONServiceServer).CreateSubmissionParent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SUBMISSIONService_CreateSubmissionParent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SUBMISSIONServiceServer).CreateSubmissionParent(ctx, req.(*CreateSubmissionParentRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _SUBMISSIONService_ListSubmissionParents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListSubmissionParentsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SUBMISSIONServiceServer).ListSubmissionParents(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SUBMISSIONService_ListSubmissionParents_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SUBMISSIONServiceServer).ListSubmissionParents(ctx, req.(*ListSubmissionParentsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _SUBMISSIONService_GetSubmissionById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSubmissionByIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SUBMISSIONServiceServer).GetSubmissionById(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SUBMISSIONService_GetSubmissionById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SUBMISSIONServiceServer).GetSubmissionById(ctx, req.(*GetSubmissionByIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SUBMISSIONService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CreateSubmissionParent",
			Handler:    _SUBMISSIONService_CreateSubmissionParent_Handler,
		},
		{
			MethodName: "ListSubmissionParents",
			Handler:    _SUBMISSIONService_ListSubmissionParents_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _SUBMISSIONService_GetSubmissionById_Handler,
		},
		{
...
const (
	...
	ASSETService_ListMstAssets_FullMethodName     = "/asset.ASSETService/ListMstAssets"
...
type ASSETServiceClient interface {
	...
	ListMstAssets(ctx context.Context, in *ListMstAssetsRequest, opts ...grpc.CallOption) (*ListMstAssetsResponse, error)
...
func (c *aSSETServiceClient) ListMstAssets(ctx context.Context, in *ListMstAssetsRequest, opts ...grpc.CallOption) (*ListMstAssetsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListMstAssetsResponse)
	err := c.cc.Invoke(ctx, ASSETService_ListMstAssets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ASSETServiceServer interface {
	...
	ListMstAssets(context.Context, *ListMstAssetsRequest) (*ListMstAssetsResponse, error)
...
func (UnimplementedASSETServiceServer) ListMstAssets(context.Context, *ListMstAssetsRequest) (*ListMstAssetsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListMstAssets not implemented")
}
...
func _ASSETService_ListMstAssets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListMstAssetsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ASSETServiceServer).ListMstAssets(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ASSETService_ListMstAssets_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ASSETServiceServer).ListMstAssets(ctx, req.(*ListMstAssetsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ASSETService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListMstAssets",
			Handler:    _ASSETService_ListMstAssets_Handler,
		},
		{
			MethodName: "GetAsset",
